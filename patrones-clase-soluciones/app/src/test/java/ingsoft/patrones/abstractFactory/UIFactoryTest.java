...
public class UIFactoryTest {
  ...
  public void testWindowsButtonRender() {
    ...
    assertEquals("Rendering Windows button with square corners", button.render());
  }
  ...
  public void testWindowsWindowRender() {
    ...
    assertEquals("Rendering Windows window with title bar and close button", window.render());
  }

  @Test
  public void testMacWindowRender() {
    Window window = new MacWindow();
    assertEquals("Rendering Mac window with title bar and close button", window.render());
  }
}
